...
const conversationStarters = [
    ...
    {id: 6, category: "familyGathering", starter: "What’s the nicest thing a family member has ever done for you?"},
    ...
    {id: 17, category: "familyGathering", starter: "What time period would you travel to?"},
    {id: 18, category: "familyGathering", starter: "What is your earliest memory?"},
...
export default function Dashboard() {
    ...
    return (
        <div>
            ...
            <h2 className="dasboard-todays-topic-question">{conversationStarters[lastUpdated-1].starter}</h2>
            </div>
            <ChatRoom />
        </div>
    )
